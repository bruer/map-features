...
test("it should show correct error message when no input is given", async () => {
    ...
    const button = getByText(/show geojson/i)
...
test("it should show correct error message when given coordinates doesn't adhere to rules specified by OSM API",
    async () => {
        const { getByLabelText, getByText, findByText } = render(<App />)
...
test("it should show correct error message when the requested bbox size is too large",
    async () => {
        const { getByLabelText, getByText, findByText } = render(<App />)
...
test("it should show throw an error when the response doesn't have valid OSM data",
    async () => {
...
test("it should show requested OSM data on the map",
    async () => {
